...
class FourM(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.enc_tok_emb = nn.Embedding(self.vocab_size, dim, padding_idx=self.padding_idx)
        ...
        self.enc_norm = nn.LayerNorm(dim, eps=1e-6, bias=use_bias)
        self.dec_norm = nn.LayerNorm(dim, eps=1e-6, bias=use_bias)
