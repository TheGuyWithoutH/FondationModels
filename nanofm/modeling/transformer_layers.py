...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, dim: int, head_dim: int = 64, mlp_ratio: float = 4., use_bias: bool = False):
        super().__init__()
        self.norm1 = 0 # TODO (use the LayerNorm defined above)
        self.query_norm = 0 # TODO (use the LayerNorm defined above)
        self.context_norm = 0 # TODO (use the LayerNorm defined above)
        self.norm2 = 0 # TODO (use the LayerNorm defined above)

        self.self_attn = 0 # TODO Attention layer
        self.cross_attn = 0 # TODO CrossAttention layer

        mlp_hidden_dim = int(dim * mlp_ratio)
        self.mlp = 0 # TODO MLP layer
...
class TransformerDecoderTrunk(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = 0 # TODO: Create a list of transformer decoder blocks and wrap inside nn.ModuleList
